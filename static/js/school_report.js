        ...
        sortedClasses.forEach(className => {
            ...
            if (classInfo.statistics) {
                ...
                row.innerHTML = `
                    ...
                    <td>${classInfo.statistics.sufficient}% (${classInfo.statistics.sufficient_count || 0})</td>
                    <td>${classInfo.statistics.high}% (${classInfo.statistics.high_count || 0})</td>
                ...
                totalData.notAssessedCount += classInfo.statistics.not_assessed_count || 0;
                totalData.initialCount += classInfo.statistics.initial_count || 0;
                totalData.averageCount += classInfo.statistics.average_count || 0;
                totalData.sufficientCount += classInfo.statistics.sufficient_count || 0;
                totalData.highCount += classInfo.statistics.high_count || 0;
